...
"Green point should not be touched.","empty",
...
"The mix up can be complicated!","empty",
...
"Great, you developed your method","empty",
new List<(int x, int y, bool centerised)>(){
...
"Solve next!","This is the forth level.\n ",
